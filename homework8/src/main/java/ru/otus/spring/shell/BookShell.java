...
public class BookShell {
    ...
    public String insert(@ShellOption(value = {"--name","-n"}) String name,
                         @ShellOption(value = {"--author-id","-a"}) String idAuthor,
                         @ShellOption(value = {"--genre-id","-g"}) String idGenre) {
        try {
    ...
    public String update(@ShellOption(value = {"--id","-i"}) String idBook,
    ...
    private String outputBookById(String id) {
