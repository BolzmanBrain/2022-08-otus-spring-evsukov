...
@Component
public class StudentTestingPresentationConsole implements StudentTestingPresentation {

    private final MessageSource messageSource;
    private final BufferedReader consoleReader;
    private final AppProps appProps;

    public StudentTestingPresentationConsole(MessageSource messageSource, AppProps appProps) {
