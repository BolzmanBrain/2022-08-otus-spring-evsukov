...
public class QuestionFactoryImpl implements QuestionFactory {
    public static final String TEXT_QUESTION_TYPE_ID = "t";
    public static final String SINGLE_SELECT_QUESTION_TYPE_ID = "ss";
    public static final String MULTI_SELECT_QUESTION_TYPE_ID = "ms";
