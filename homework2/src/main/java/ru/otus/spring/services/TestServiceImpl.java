...
public class TestServiceImpl implements TestService {
    ...
    @Autowired
    public TestServiceImpl(QuestionPresentation questionPresentation, QuestionDao questionDao, @Value("${test.percent_of_correct_answers_for_credit}") int percentOfCorrectAnswersForCredit) {
